...
const N3Vocabularies = ({data}) => {
  ...
  return (
    <main className='max-w-[1440px] px-5 lg:px-10 mx-auto py-12 mt-16'>
      <h1 className='text-center w-full text-3xl md:text-4xl text-gray-200 font-semibold'>N3 Level Vocabularies</h1>
...
export default N3Vocabularies

export const getStaticProps = async() => {

  const res = await fetch(`https://jlpt-vocab-api.vercel.app/api/words/all?level=3`)
